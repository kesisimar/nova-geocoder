            ...
            try:
                ...
                if not location:
                    ...
                    prompt = (
                        ...
                        f"- Σημερινή Περιοχή/Οδός: {location.address}\n"
                        f"- Σημερινός Δήμος (Καλλικράτης): {dimos}\n"
                        f"- Σημερινός Νομός: {nomos}\n\n"
                        f"ΟΔΗΓΙΕΣ:\n"
                        f"1. Προσδιόρισε ακριβώς σε ποιον Δήμο (Καποδίστριας) και σε ποιον Νομό ανήκε αυτή η περιοχή το 2009.\n"
                        f"2. Εάν η περιοχή είναι χωριό, βρες σε ποιο δημοτικό διαμέρισμα ανήκε.\n"
                        f"3. Εάν δεν είσαι 100% σίγουρος, απάντησε 'Δεν βρέθηκε' για να αποφύγουμε τα λάθη.\n"
                        f"4. Απάντησε ΑΥΣΤΗΡΑ με το παρακάτω φορμάτ και τίποτα άλλο:\n"
                        f"ΠΡΟ_ΔΗΜΟΣ: [Όνομα]\n"
                        f"ΠΡΟ_ΝΟΜΟΣ: [Όνομα]"
                    )
